...
| callback | <code>function</code> |  | __Parameters:__ element, index, and array.<br>__Context:__ same as that provided to the main function.<br>__Return:__ A falsey value to indicate a failure.<br>_May return a Promise. Rejections are not caught_. |
